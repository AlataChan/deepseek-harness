...
| [`client/`](client/README.md) | Browser-compatible interactive-client side shared by Web and VS Code: shell, carriers, object services, slots, `ui-*` plugins | Product — stable API |
| [`ui/`](ui/README.md) | Node-native user interfaces | Product — stable API |
