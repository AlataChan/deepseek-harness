...
export const zh = {
  trigger: '团队协作',
  triggerHint: '打开后先看协作关系；名单与任务在下方。有队友时顶栏显示人数徽章。',
  ...
  howToUse:
    '点开本面板即可看到「协作关系」。在对话里指挥主助理即可，不必记工具名；下方按钮可把启动话术填入输入框（不会自动发送）。',
  topology: '协作关系',
  topologyHint: '与名单同一份数据：成员状态、待投递消息边、任务依赖边；不含消息正文。打开/刷新面板或改任务时更新，不轮询。',
  topologyShow: '显示关系图',
  topologyHide: '隐藏关系图',
...
export const en = {
  trigger: 'Team',
  triggerHint: 'Opens on the collaboration map first; roster and tasks follow. Teammate count shows on the header badge.',
  ...
  howToUse:
    'Opening this panel shows Collaboration map first. Steer the lead in chat — you do not need tool names. Buttons below fill a starter prompt into the composer (nothing is sent automatically).',
  topology: 'Collaboration map',
  topologyHint: 'Same TeamView as the roster: member status, pending message edges, and task-dependency edges — no message bodies. Updates on open/refresh/task edits, never by polling.',
