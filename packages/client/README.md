...
Each child reference owns its contract and detailed behavior. The [slot system standard](../../.agents/notes/implemented/architecture/2026-07-22-slot-type-chain-implementation.md), [web client architecture note](../../.agents/notes/implemented/architecture/2026-07-19-gui-web-client-architecture.md), and [VS Code client note](../../.agents/notes/implemented/feature/2026-08-15-vscode-client.md) own the cross-package composition and loading decisions.
