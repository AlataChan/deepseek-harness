...
export const zh = {
  ...
  'input.attachKnowledge': '添加到知识库（制度 / PDF）',
  'input.attachKnowledgeHint': '制度 PDF 请用 @ 引用工作区文件，或从首页「知识库」添加文档',
  'input.attachSessionDocument': '看这份文档（仅本会话）',
  'input.attachSessionDocumentHint': 'PDF 和 HTML 需要桌面运行时提取；Markdown / TXT 可直接加入草稿',
  ...
  'input.attachSessionDocumentUnsupported': '仅支持 Markdown、TXT、HTML、PDF。表格请走问数',
...
export const en = {
  ...
  'input.attachKnowledge': 'Add to knowledge library (policies / PDF)',
  ...
  'input.attachSessionDocumentHint': 'PDF and HTML need the desktop runtime. Markdown and TXT can be added directly',
  ...
  'input.attachSessionDocumentUnsupported': 'Only Markdown, TXT, HTML, and PDF. Spreadsheets go through Ask Data',
