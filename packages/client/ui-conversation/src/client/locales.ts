...
export const zh = {
  ...
  'input.attachFile': '引用工作区文件（@）',
  'input.attachKnowledge': '添加到知识库（制度 / Word / PDF）',
  'input.attachKnowledgeHint': '制度、Word、PDF 请用 @ 引用工作区文件，或从首页「知识库」添加文档',
  'input.attachSessionDocument': '看这份文档（仅本会话）',
  'input.attachSessionDocumentHint': 'PDF、HTML 和 Word 需要桌面运行时提取；Markdown / TXT 可直接加入草稿',
  'input.attachSessionDocumentReady': '已提取，随下一条发送，不入库',
  'input.attachSessionDocumentTruncated': '已提取并截断，随下一条发送，不入库',
  'input.attachSessionDocumentEmpty': '这份文件没有可提取的文字',
  'input.attachSessionDocumentReadFailed': '读不了这份文件',
  'input.attachFileMissed': '没有读到所选文件，请再选一次',
  'input.attachSessionDocumentUnsupported': '仅支持 Markdown、TXT、HTML、PDF、Word。表格请走问数',
  'input.attachSessionDocumentSpreadsheet': '表格请走首页「问数」，不要当作会话附件',
  'input.attachSessionDocumentWorking': '正在提取文档…',
  'input.attachSessionDocumentChip': '仅本会话：{name}',
  'input.attachSessionDocumentRemove': '去掉 {name}',
  'input.attachImageChoose': '选择图片',
  'input.attachSessionDocumentChoose': '选择文档',
  'input.attachChooserHint': '从电脑里选文件，选中后会出现在输入框',
  'input.attachChooserDismiss': '取消',
  'input.attachFileHint': '在列表里点选工作区文件。列表马上消失表示工作区里还没有文件',
  'input.commands': '指令',
  'input.stop': '停止生成',
  'input.send': '发送消息',
...
export const en = {
  ...
  'input.attach': 'Add',
  'input.attachImage': 'Add images',
  'input.attachFile': 'Mention a workspace file (@)',
  'input.attachKnowledge': 'Add to knowledge library (policies / Word / PDF)',
  'input.attachKnowledgeHint': 'Use @ for a workspace file, or add the document from Knowledge on the home screen',
  'input.attachSessionDocument': 'Read this document (this session only)',
  'input.attachSessionDocumentHint': 'PDF, HTML, and Word need the desktop runtime. Markdown and TXT can be added directly',
  'input.attachSessionDocumentReady': 'Extracted. It will send with the next message and will not enter the library',
  'input.attachSessionDocumentTruncated': 'Extracted and truncated. It will send with the next message and will not enter the library',
  'input.attachSessionDocumentEmpty': 'This file has no extractable text',
  'input.attachSessionDocumentReadFailed': 'This file could not be read',
  'input.attachFileMissed': 'The chosen file did not arrive. Choose it again',
  'input.attachSessionDocumentUnsupported': 'Only Markdown, TXT, HTML, PDF, and Word. Spreadsheets go through Ask Data',
  'input.attachSessionDocumentSpreadsheet': 'Spreadsheets go through Ask Data on the home screen, not as a session attachment',
  'input.attachSessionDocumentWorking': 'Extracting document…',
  'input.attachSessionDocumentChip': 'This session only: {name}',
  'input.attachSessionDocumentRemove': 'Remove {name}',
  'input.attachImageChoose': 'Choose images',
  'input.attachSessionDocumentChoose': 'Choose a document',
  'input.attachChooserHint': 'Pick a file on this computer. It will appear in the composer',
  'input.attachChooserDismiss': 'Cancel',
  'input.attachFileHint': 'Pick a workspace file in the list. If the list vanishes, the workspace has no files yet',
