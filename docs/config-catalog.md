...
- `@deepseek-ai/dsh-experimental-commerce-mode` — requires `sessionProjections` · `subprocess` ([`packages/experimental/commerce-mode/src/index.ts`](../packages/experimental/commerce-mode/src/index.ts))
...
- `@deepseek-ai/dsh-host-commerce` — abstract `Commerce` ([`packages/host/commerce/src/index.ts`](../packages/host/commerce/src/index.ts))
