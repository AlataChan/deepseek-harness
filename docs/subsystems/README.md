...
| [tui.md](tui.md) | the Node terminal client's startup value and mounted-controller lifecycle events |
...
| [client-modules.md](client-modules.md) | transport-neutral `dsh.client` discovery and `ClientBootGraph` composition, plus the Web route adapter |
