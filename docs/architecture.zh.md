...
[`dsh-base`](../packages/bundle/base/README.zh.md) 是每个 profile 的第一层：模型适配器、工具、持久化、沙箱与审批策略、设置、凭据、遥测。[`dsh-tui-app`](../packages/bundle/tui-app/README.zh.md) 增加仅限 Node 的终端呈现与直接进程内交互路径。[`dsh-client-app`](../packages/bundle/client-app/README.zh.md) 增加传输无关的交互式 Host 服务与 Client Plugin；[`dsh-web-app`](../packages/bundle/web-app/README.zh.md) 与 [`dsh-vscode-app`](../packages/bundle/vscode-app/README.zh.md) 再分别增加浏览器或有界进程 carrier 及 host 集成。[`dsh-headless`](../packages/bundle/headless/README.zh.md) 增加一次性运行器，且完全不带服务器。
