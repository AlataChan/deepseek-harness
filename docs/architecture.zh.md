...
[`dsh-base`](../packages/bundle/base/README.md) 是每个 profile 的第一层：模型适配器、工具、持久化、沙箱与审批策略、设置、凭据、遥测。[`dsh-client-app`](../packages/bundle/client-app/README.md) 增加传输无关的交互式 Host 服务与 Client Plugin，[`dsh-web-app`](../packages/bundle/web-app/README.md) 再增加浏览器载体与集成。[`dsh-headless`](../packages/bundle/headless/README.md) 增加一次性运行器，且完全不带服务器。
