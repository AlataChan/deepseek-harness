...
来源：[`packages/client/connection/src/index.ts:35`](../packages/client/connection/src/index.ts)

<a id="deepseek-aidsh-client-connection-vscode"></a>

## `@deepseek-ai/dsh-client-connection-vscode`

需要：`apiProxy` · `clientModules`
...
需要：`agentDefaultModel` · `agents` · `approval` · `commands` · `sessionQuery` · `sessions` · `tools` · `userQuestions`
...
依赖：[`SessionIdType`](subsystems/core.zh.md)

来源：[`packages/ui/tui/src/index.ts:34`](../packages/ui/tui/src/index.ts)
...
- `@deepseek-ai/dsh-host-client-modules-web` — 需要 `clientModules` · `webServer`（[`packages/host/client-modules-web/src/index.ts`](../packages/host/client-modules-web/src/index.ts)）
...
- `@deepseek-ai/dsh-client-app`（[`packages/bundle/client-app/src/index.ts`](../packages/bundle/client-app/src/index.ts)）
