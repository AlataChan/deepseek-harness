...
| --- | --- | --- | --- | --- | --- | --- |
| `ctx.tuiStartup` | `bundle` | [`tui-app`](../packages/bundle/tui-app) | - | [`tui`](../packages/ui/tui) | - | The TUI profile parses application arguments once and supplies the selected fresh or resume startup intent to the terminal runtime. |
